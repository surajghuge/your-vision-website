...
const Catalog = () => {
  ...
  const initialBU: BusinessUnit | "all" =
    buParam && businessUnits.some((b) => b.id === buParam)
      ? (buParam as BusinessUnit)
      : "all";

  const [search, setSearch] = useState("");
  const [selectedBU, setSelectedBU] = useState<BusinessUnit | "all">(initialBU);
